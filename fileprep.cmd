set MAC_INSTALL=C:\Atmel\MAC_v_2_8_0
set GAWK=gawk.exe
set RM=rm

set APP=Nobeacon_Device
set APP_SCR_DIR=Nobeacon_Application/Device
...
set APP=Nobeacon_Coordinator
set APP_SCR_DIR=Nobeacon_Application/Coordinator
mkdir -p examples/$APP
